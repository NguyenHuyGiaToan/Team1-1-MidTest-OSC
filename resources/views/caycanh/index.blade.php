<x-cay-canh-layout>
    ...
    <style>
        ...
        .pagination-container span[aria-disabled] {
            padding: 8px 12px;
    ...
    <div class="container">
        ...
        <div class="filter-section">
            ...
            <a href="{{ request()->fullUrlWithQuery(['sort_gia' => null, 'de_cham_soc' => null, 'bong_ram' => null]) }}" class="filter-btn" style="color: red; border-color: red;">Xóa lọc</a>
            @endif
        </div>
        @if(session('success'))
        <div style="background-color: #d1ecf1; color: #0c5460; padding: 10px; border: 1px solid #bee5eb; border-radius: 5px; text-align: center; margin-bottom: 20px; font-weight: bold;">
            {{ session('success') }}
        </div>
        @endif
        <div class="grid">
